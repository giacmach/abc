...
class NearEarthObject:
    ...
    def __str__(self):
        """Return `str(self)`."""
        diameter = '' if math.isnan(self.diameter) else f'has a diameter of {self.diameter:.3f} km'
        return f"NEO {self.fullname} {diameter} and {self.is_hazardous()} potentially hazardous."
